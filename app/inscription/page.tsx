...
export default function Inscription() {
  ...
  const [etape, setEtape] = useState<"inscription" | "confirmation">("inscription");
  ...
  const inscrire = async () => {
    ...
    if (!form.ville?.trim() || !form.code_postal?.trim() || !form.pays) {
      alert("Merci de renseigner le pays, le code postal et la ville.");
      return;
    }
    setLoading(true);
  ...
  return (
    <main style={{ fontFamily: "sans-serif", maxWidth: "440px", margin: "60px auto", padding: "20px" }}>
      ...
      <div style={{ marginBottom: "14px" }}>
        <label style={{ display: "block", fontSize: "13px", fontWeight: "500", marginBottom: "5px", color: "#444" }}>Pays *</label>
        <select
          required
          value={form.pays}
      ...
      <div style={{ marginBottom: "14px" }}>
        <label style={{ display: "block", fontSize: "13px", fontWeight: "500", marginBottom: "5px", color: "#444" }}>Code postal *</label>
        <input
      ...
      <p style={{ textAlign: "center", fontSize: "13px", color: "#666" }}>
        Déjà membre ?{" "}
        <a href="/connexion" style={{ color: "#1D9E75" }}>
          Se connecter
        </a>
      </p>
    </main>
